...
export default function CoursesPage() {
  ...
  useEffect(() => {
    const fetchCourses = async () => {
      try {
        const response = await fetch('http://localhost:8085/course/all-courses')
        if (!response.ok) {
  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-gray-100 via-purple-50 to-gray-100 py-16 px-4 flex items-center justify-center">

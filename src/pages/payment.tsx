...
export default function PaymentPage() {
  ...
  const handlePayWithRazorpay = () => {
    ...
    // Amount here is demo-only; real apps should calculate from backend
    const amountInRupees = 499; // example price
    ...
    const options = {
      ...
      handler: function (response: any) {
        ...
        // After successful payment, send user to dedicated course videos page
        router.push(`/my-course/${course}`)
      },
      prefill: {
        name: '',
        email: '',
  ...
  }, [hasAutoOpened, isRazorpayReady, isProcessing, course])
